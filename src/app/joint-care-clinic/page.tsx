...
export default function Page() {
  return (
    <>
      ...
      <FAQSchema questions={[
        { question: 'What is the Joint Care Clinic?', answer: 'The Joint Care Clinic at Valli Super Specialty Hospital provides advanced, specialized care for related conditions.' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-gray-300 text-base md:text-lg max-w-xl font-normal leading-relaxed">
                Dedicated center for comprehensive joint preservation, robotic joint replacements, and advanced arthroscopic restoration.
              </p>
