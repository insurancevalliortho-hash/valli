...
export default function Page() {
  return (
    <>
      ...
      <FAQSchema questions={[
        { question: 'What is the Sports Training?', answer: 'The Sports Training at Valli Super Specialty Hospital provides advanced, specialized care for related conditions.' },
