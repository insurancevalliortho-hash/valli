...
export async function POST(request: Request) {
  try {
    ...
    const razorpay_order_id = body.razorpay_order_id || body.order_id || body.orderId || body.razorpayOrderId || body.orderCreationId;
    const razorpay_payment_id = body.razorpay_payment_id || body.payment_id || body.paymentId || body.razorpayPaymentId;
    const razorpay_signature = body.razorpay_signature || body.signature || body.razorpaySignature;
