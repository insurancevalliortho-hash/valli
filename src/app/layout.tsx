...
export const metadata: Metadata = {
    ...
    category: "Medical",
    title: {
        default: "Best Ortho Doctor & Orthopedic Hospital in Salem | Dr. T. Natanasabapathy | Valli Super Specialty Hospital",
        template: "%s | Valli Super Specialty Hospital Salem",
    },
    description: "Valli Super Specialty Hospital (formerly Valli Orthopedic and Sports Hospital) — Salem's top orthopedic hospital led by Dr. T. Natanasabapathy. Specializing in robotic knee replacement, spine surgery, 24/7 emergency trauma, and sports medicine. Cashless insurance available.",
    keywords: [
    ...
    openGraph: {
        ...
        description: "Salem's most trusted orthopedic hospital — robotic knee replacement, trauma care, sports injury treatment, and 24/7 emergency. 19,000+ patients treated. Led by Dr. T. Natanasabapathy.",
