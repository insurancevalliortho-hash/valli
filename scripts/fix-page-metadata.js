...
const pageMetadata = {
  'arthroscopy': {
    ...
    description: 'Expert arthroscopic (keyhole) surgery in Salem at Valli Super Specialty Hospital. Minimally invasive treatment for ACL tears, meniscus injuries, rotator cuff, and shoulder disorders by Dr. T. Natanasabapathy. Fast recovery, same-day discharge.',
  ...
  'back-pain-and-spinal-disorders': {
    ...
    description: 'Comprehensive back pain and spinal disorder treatment in Salem at Valli Super Specialty Hospital. Expert care for disc herniation, lumbar spondylosis, sciatica, spinal stenosis, and spondylolisthesis. Surgery and non-surgical options available.',
  ...
  'bone-cancer-treatment': {
    ...
    description: 'Specialised bone cancer and bone tumour treatment at Valli Super Specialty Hospital, Salem. Expert oncologic orthopaedic care for osteosarcoma, Ewing\'s sarcoma, chondrosarcoma, and metastatic bone disease. Limb-salvage surgery and comprehensive oncology support.',
  ...
  'joint-care-clinic': {
    ...
    description: 'Salem\'s leading joint care clinic at Valli Super Specialty Hospital. Expert total knee replacement, total hip replacement, shoulder replacement, and minimally invasive joint surgeries. Led by Dr. T. Natanasabapathy with 3,000+ successful joint replacements.',
  ...
  'sports-training': {
    ...
    description: 'Professional sports training, conditioning, and rehabilitation programs at Valli Super Specialty Hospital Salem. Science-backed athletic performance enhancement, post-injury return-to-sport training, and physiotherapy-led conditioning programs.',
  ...
  'failed-surgery-corrections': {
    ...
    description: 'Expert revision and correction surgery for failed orthopaedic procedures in Salem at Valli Super Specialty Hospital. Specialised care for failed knee/hip replacement, failed spine surgery, implant failure, and post-surgical complications. Second opinion available.',
